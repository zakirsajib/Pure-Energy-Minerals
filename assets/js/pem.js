...
*/	
		...
		/*-------------------------------------------------------------------*/
		/*  0. Scroll. Requires Nicescroll Javascript.
		/*-------------------------------------------------------------------*/
		...
		$j(window).scroll(function(){
		     scroll = $j(window).scrollTop();
				if (scroll >= 50){
				  	...
				  	//$j('.header-media').insertAfter('#pem-navbar-collapse-right');
				  	//$j('.header-media').css({
					//  	'right':0,
					 // 	'top': '12px'	
				  	//});
				  	//$j('.header-media ul li').css({
					  //	'padding':'0px 5px 0px 0px'
				  	//});
				  	//$j('.header-media img').css('max-width', '80%');
					 ...
					 // 	'padding':'0px 10px'
				  	//});
				  	//$j('.header-media img').css('max-width', '100%');
