			...
			<div class="row">
				<div class="entry-content">
					<?php
						...
						if(get_field('reports_presentations')): 
							while(has_sub_field('reports_presentations')): ?>
								<div class="col-md-6">
									<div class="reports_presentations match-height">
										<?php the_sub_field('reports_presentations_info'); ?>
									</div>
								</div>
							<?php endwhile;
						endif;
